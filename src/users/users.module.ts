...
@Module({
  ...
  providers: [UsersService, UsersCreateManyProvider, CreateUserProvider], // providers means providing this particular service to all the local components of user module
